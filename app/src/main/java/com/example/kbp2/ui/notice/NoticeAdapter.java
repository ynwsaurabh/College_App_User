...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, int position) {
        ...
        holder.deleteNoticeTitle.setMovementMethod(LinkMovementMethod.getInstance());


        try {
            if (currentItem.getImage() != null) {
                Glide.with(context).load(currentItem.getImage()).into(holder.deleteNoticeImage);
                holder.deleteNoticeImage.setMaxHeight(500);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public class NoticeViewAdapter extends RecyclerView.ViewHolder {
        ...
        private TextView deleteNoticeTitle, date, time,description;
        ...
        public NoticeViewAdapter(@NonNull View itemView) {
            ...
            description = itemView.findViewById(R.id.deleteNoticeDescription);
        }
    }
}
